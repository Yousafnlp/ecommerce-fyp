...
export function SearchResults({
  ...
  return <div className="space-y-6">
      ...
      {viewMode === "grid" ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map(product => <Card key={product.id} className="group hover:shadow-lg transition-all duration-300">
              <CardHeader className="p-4">
                <div className="aspect-square relative mb-4 overflow-hidden rounded-lg bg-muted">
                  ...
                  {product.originalPrice && <Badge variant="destructive" className="absolute top-2 left-2">
                      Sale
                    </Badge>}
                </div>
              ...
              <CardContent className="p-4 pt-0">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className={`text-xs px-2 py-1 rounded-full ${product.inStock ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    {product.originalPrice && <div className="text-sm text-muted-foreground line-through">
          ...
          {products.map(product => <Card key={product.id} className="hover:shadow-md transition-shadow">
      ...
      {/* Load More */}
      {products.length > 0 && <div className="text-center pt-8">
